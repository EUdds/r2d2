...
public:
  DomeControllerNode() : Node("dome_ctlr")
  {
    ...
    pins_.step = declare_parameter<int>("step_pin", 17);
    pins_.dir = declare_parameter<int>("dir_pin", 4);
    pins_.enable = declare_parameter<int>("enable_pin", 5);
    ...
    pins_.ms1 = declare_parameter<int>("ms1_pin", 27);
    pins_.has_ms2 = declare_parameter<bool>("ms2_present", true);
    pins_.ms2 = declare_parameter<int>("ms2_pin", 22);
